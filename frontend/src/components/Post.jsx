    ...
    const bookmarkHandler = async () => {
        try {
            ...
            if (res.data.success) {
                ...
                const updatedBookmarks = bookmarked ? user.bookmarks.filter((bookmark) => bookmark !== post?._id): [...user.bookmarks, post?._id];
    ...
    return (
        <div className='my-8 w-full max-w-sm mx-auto'>
            ...
            <div className='flex items-center justify-between my-2'>
                ...
                {
                    bookmarked ? <Bookmark onClick={bookmarkHandler} className='cursor-pointer hover:text-gray-600 fill-slate-950' /> : <Bookmark onClick={bookmarkHandler} className='cursor-pointer hover:text-gray-600' />
                }
